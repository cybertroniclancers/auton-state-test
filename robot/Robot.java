...
// This function is run when the robot is first started up and should be
  ...
  public void autonomousInit() {
   ...
   //     AutonMotions MOVE1;
    ...
    m_robotDrive.arcadeDrive(-0.6, 0.0);   // get it started
    }
    ...
    public void autonomousPeriodic() {
     ...
     case MOVE1:
      ...
      //test at -90 should be <=-90 as you have it
      //test at -180 test should be >0 
     // test at 90 should be <=90 as you have it
      //test at 0 should be <=0 as you have it
